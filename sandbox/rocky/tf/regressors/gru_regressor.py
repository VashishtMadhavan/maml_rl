...
class GRURegressor(LayersPowered, Serializable):
    """
    A class for performing regression by fitting a GRU Gaussian distribution to the outputs.
    """
    ...
    def __init__(
        ...
        with tf.variable_scope(name):
            ...
            LayersPowered.__init__(self, [l_mean, l_log_std, l_step_log_std])
            ...
            dist = self._dist = RecurrentDiagonalGaussian(output_dim)
